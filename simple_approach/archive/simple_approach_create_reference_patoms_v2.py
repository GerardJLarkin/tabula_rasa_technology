...
from simple_approach_compare_v1 import compare
...
#patoms = [np.load(f, allow_pickle=True) for f in file_paths][:300]
patoms = {}
...
# patoms = dict(islice(patoms.items(), 40))
...
with Pool(processes=8) as pool:
    ...
    results = pool.starmap(compare, tasks, chunksize=500)
