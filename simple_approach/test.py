...
# data = [(10,11), (20,22), (30,29), (40,32), (50,98), (60,16)]
...
#         dx1 = b[0] - a[0]
#         dy1 = b[1] - a[1]
#         seg_1 = int((np.degrees(np.arctan2(dy1, dx1)) % 360) // segment)
#         dx2 = c[0] - b[0]
#         dy2 = c[1] - b[1]
#         seg_2 = int((np.degrees(np.arctan2(dy2, dx2)) % 360) // segment)
#         print(f"Window: {a}, {b}, {c} → vector = {seg_1, seg_2}")
...
vrld = dict.fromkeys(vec_keys, 0.0) # 61.5MB to start
