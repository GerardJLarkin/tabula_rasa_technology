...
con2d = sqlite3.connect("ref2d.db")
cur2d = con2d.cursor()
...
# def ref_patoms2d(x_len, y_len, single_frame_array):
...
#         patom = [norm_x, norm_y, pattern_centroid_x, pattern_centroid_y, 0, 0, patom_time]
