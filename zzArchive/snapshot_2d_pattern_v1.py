...
def patoms2d(x_len, y_len, single_frame_array):
    ...
    for ind, pat in enumerate(s_res):
        ...
        centroid_list = [tuple([-1.0]+position_centroid+pattern_centroid+[0.0]+[ind])]
        ...
        patom_ind = [ind] * pat_len
        patom = list(zip(val, x, y, norm_x, norm_y, norm_dist, patom_ind))
