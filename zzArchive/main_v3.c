...
// -------------------------------------------------------------------------
// PART 3: Frame Processing - Optimized Group Counting and Summary
// -------------------------------------------------------------------------
...
void process_frame_example(unsigned int *color_array, int width, int height,
    ...
    // Parallel reduction to compute max label.
    ...
    // Allocate and initialize group counts array.
    ...
    // Parallel counting using atomic updates.
    ...
    // Print summary only for groups with at least 10 pixels.
...
// -------------------------------------------------------------------------
// PART 4: Capture Loop and Main - Memory Reuse
// -------------------------------------------------------------------------
...
void capture_loop(frame_callback_t process_frame) {
    ...
    while (1) {
        ...
        // Fill color_array from YUYV data.
